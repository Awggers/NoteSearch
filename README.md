...
The goal is to create a fast and personal search tool to that assists in locating specific terms inside a growing set of notes without having to manually
